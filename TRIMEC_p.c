...
int main (int argc, char *argv[]) 
{
  ...
  scanf("%s", filename);
  printf("Enter start and end range for partial tests: range should be within 0<= range <=1\n");
  ...
  printf("Locading corresponding classifier at k=%d....\n",k);
